    ...
    $(document).ready(function () {
        ...
        if( $.fn.dialog ) {
            ...
            var rebuildDialog = $("#ajax-dialog").dialog({
                autoOpen: false,
                title: "Processing Sergeant Major of the Corp Eligibility list",
                modal: true,
                width: "600",
                buttons: [{
                    text: "Close Window",
                ...
                buttons: [{
                    ...
                    click: function() {
                        ...
                        $.ajax({
                            ...
                            data: { ajax: true, action: "smoc", playerId: selectedId },
                            dataType: "json",
        ...
        $("#rebuild-btn").click(function() {
            ...
            $.ajax({
                ...
                success: function(result)
                {
                    ...
                    {
                        alertStyle = 'success';
                        message = 'The Sergeant Major of the Corp Eligibility list has been successfully refreshed.';
                    }
                    else
                    {
                        alertStyle = 'error';
                        message = 'There was an error refreshing the Sergeant Major of the Corp eligibility list! ' + result.message;
                    }
                ...
                error: function()
                {
                    ...
                    $('div#jui-global-message')
                        .attr('class', 'alert error')
                        .html('There was an error refreshing the Sergeant Major of the Corp eligibility list!')
                        .append('<span class="close-bt"></span>')
                        .slideDown(500);
